...
public class OddEvenPrint {
    ...
    public static void main(String[] args) {
        Thread evenPrintThread = new Thread(new NumberPrintRunnable());
        evenPrintThread.start();

        Thread oddPrintThread = new Thread(new NumberPrintRunnable());
     ...
     * 奇数打印线程
     */
    private static class NumberPrintRunnable implements Runnable {
