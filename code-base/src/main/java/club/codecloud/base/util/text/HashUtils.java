...
public class HashUtils {
    ...
    public static byte[] sha1(String input) {
        return digest(input.getBytes(CharsetUtils.CHARSET_UTF_8), get(SHA_1_DIGEST), null, 1);
    }
    ...
    public static byte[] sha1(String input, byte[] salt) {
        return digest(input.getBytes(CharsetUtils.CHARSET_UTF_8), get(SHA_1_DIGEST), salt, 1);
    }
    ...
    public static byte[] sha1(String input, byte[] salt, int iterations) {
        return digest(input.getBytes(CharsetUtils.CHARSET_UTF_8), get(SHA_1_DIGEST), salt, iterations);
    }
    ...
    public static int crc32AsInt(String input) {
        return crc32AsInt(input.getBytes(CharsetUtils.CHARSET_UTF_8));
    }
    ...
    public static long crc32AsLong(String input) {
        return crc32AsLong(input.getBytes(CharsetUtils.CHARSET_UTF_8));
    }
    ...
    public static int murmur32AsInt(String input) {
        return Hashing.murmur3_32(MURMUR_SEED).hashString(input, CharsetUtils.CHARSET_UTF_8).asInt();
    }
    ...
    public static long murmur128AsLong(String input) {
        return Hashing.murmur3_128(MURMUR_SEED).hashString(input, CharsetUtils.CHARSET_UTF_8).asLong();
    }
}
